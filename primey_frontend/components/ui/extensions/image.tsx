    ...
    return [
      {
        ...
        getAttrs: (element) => {
          ...
          return {
            ...
            width: el.getAttribute("width") || el.style.width || "100%",
            ...
            aspectRatio: el.getAttribute("data-aspect-ratio")
              ? Number(el.getAttribute("data-aspect-ratio"))
              : null,
          };
        },
      },
...
function TiptapImage(props: NodeViewProps) {
  ...
  }, [resizing, resizeInitialMouseX, resizeInitialWidth, resizingPosition]);
